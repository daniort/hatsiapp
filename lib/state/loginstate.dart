...
import 'package:hatsiapp/error/wids.dart';
...
class LoginState with ChangeNotifier {
  ...
  Stream<List<UserLogin>> getUserList() {
    return _db.collection('user').snapshots().map((snapShot) => snapShot
        .documents
        .map((document) => UserLogin.fromJson(document.data))
        .toList());
  }
}
